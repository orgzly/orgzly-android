...
//                break;
    ...
    public void testMultipleRooks() {
        ...
        shelfTestUtils.setBookLink(book.getId(), "mock://repo-a", "mock://repo-a/book.org");
...
//    }
    ...
    public void testMockFileRename() throws IOException {
        ...
        // Rename rook
        repo.moveBook(Uri.parse("mock://repo-a/Booky.org"), Uri.parse("mock://repo-a/BookyRenamed.org"));
    ...
    public void testDropboxFileRename() throws IOException {
        ...
        repo.moveBook(vrook.getUri(), repo.getUri().buildUpon().appendPath("notebook-renamed.org").build());
