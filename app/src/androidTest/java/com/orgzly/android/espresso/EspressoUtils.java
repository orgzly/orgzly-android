...
class EspressoUtils {
    ...
    static final int SETTINGS_STATE_KEYWORDS = 17;
    static final int SETTINGS_DEFAULT_PRIORITY = 18;
    static final int SETTINGS_LOWEST_PRIORITY = 19;

    static final int SETTINGS_NEW_NOTE_STATE = 21;
    static final int SETTINGS_CREATED_AT = 23;

    static final int SETTINGS_REPOS = 29;

    static final int IMPORT_GETTING_STARTED = 31;
    static final int SETTINGS_CLEAR_DATABASE = 32;
