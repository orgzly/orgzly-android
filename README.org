...
Orgzly Revived project aims to continue development of the Orgzly application. The rebranding is due 
...
We generally plan to leave existing open issues in the original repository and reference them here as 
they are addressed.
